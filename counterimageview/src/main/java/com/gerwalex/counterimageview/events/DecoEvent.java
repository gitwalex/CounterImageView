 ...
 */
package com.gerwalex.counterimageview.events;
...
/**
 * Encapsulates a scheduled operation to perform on the {@link DecoView}
 * <p/>
 ...
 * <p/>
 * Use the {@link DecoEvent.Builder} class to construct the Event
 * <p/>
 ...
 * {@link DecoEvent.Builder#setListener(ExecuteEventListener)}
 */
...
public class DecoEvent {
    ...
    public static class Builder {
         ...
         * {@link DecoDrawEffect.EffectType#drawExplode(Canvas, RectF, float)}
         *
         ...
         * view (ie. Hide/Show), while others ie. {@link DecoEvent.EventType#EVENT_MOVE}
         ...
         * {@link SeriesItem.Builder#setInterpolator(Interpolator)}
         *
