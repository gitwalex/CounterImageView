...
public class Sample1Fragment extends SampleFragment {
    ...
    protected void createTracks() {
        ...
        decoView.addSeries(new SeriesItem.Builder(Color.argb(255, 64, 255, 64), Color.argb(255, 255, 0, 0))
                .setRange(0, seriesMax, seriesMax).setInitialVisibility(false).setLineWidth(getDimension(50f)).build());
        decoView.addSeries(new SeriesItem.Builder(Color.argb(255, 0, 0, 0)).setRange(0, seriesMax, seriesMax)
                .setInitialVisibility(false).setLineWidth(getDimension(24f)).build());
        SeriesItem seriesItem1 = new SeriesItem.Builder(Color.argb(255, 64, 255, 64), Color.argb(255, 255, 0, 0))
                .setRange(0, seriesMax, 0).setInitialVisibility(false).setLineWidth(getDimension(50f))
                .setCapRounded(true).setShowPointWhenEmpty(true).build();
    ...
    protected void setupEvents() {
        ...
        decoView.addEvent(new DecoEvent.Builder(EventType.EVENT_SHOW, true).setDelay(1000).setDuration(2000).build());
        ...
        decoView.addEvent(new DecoEvent.Builder(EventType.EVENT_HIDE, false).setDelay(19000).setDuration(2000)
