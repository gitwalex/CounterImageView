...
public class SampleGenericFragment extends SampleFragment {
    ...
    protected void setupEvents() {
        ...
        arcView.addEvent(new DecoEvent.Builder(EventType.EVENT_SHOW, true).setDelay(1000).setDuration(2000).build());
        ...
        arcView.addEvent(new DecoEvent.Builder(EventType.EVENT_HIDE, false).setDelay(11000).setDuration(2000)
